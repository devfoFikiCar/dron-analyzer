...
public class yTimeGraph extends JFrame{
    private JPanel panel1;

    private ArrayList<String> dates = new ArrayList<>();
    private ArrayList<String> alts = new ArrayList<>();

    public yTimeGraph(String title) {
        super(title);
        ...
        JFreeChart chart = ChartFactory.createLineChart(
                "Yaw change over time", // Chart title
                "Time", // X-Axis Label
                "Yaw", // Y-Axis Label
                dataset
        );
    ...
    private DefaultCategoryDataset createDataset() {
        ...
        for(int i = 0; i < dates.size(); i++){
            dataset.addValue(Double.parseDouble(alts.get(i)), "Yaw", dates.get(i));
    ...
    public void yTimeGraphOpen() {
        yTimeGraph graph = new yTimeGraph("Yaw/Time Graph");
