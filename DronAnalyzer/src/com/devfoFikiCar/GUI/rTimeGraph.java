...
public class rTimeGraph extends JFrame{
    private JPanel panel1;
    private ArrayList<String> dates = new ArrayList<>();
    private ArrayList<String> alts = new ArrayList<>();

    public rTimeGraph(String title) {
        super(title);
        ...
        JFreeChart chart = ChartFactory.createLineChart(
                "Roll change over time", // Chart title
                "Time", // X-Axis Label
                "Roll", // Y-Axis Label
                dataset
        );
    ...
    private DefaultCategoryDataset createDataset() {
        ...
        for(int i = 0; i < dates.size(); i++){
            dataset.addValue(Double.parseDouble(alts.get(i)), "Roll", dates.get(i));
    ...
    public void rTimeGraphOpen() {
        rTimeGraph graph = new rTimeGraph("Roll/Time Graph");
